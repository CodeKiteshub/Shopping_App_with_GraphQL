...
class LoginPagePassView extends GetView<LoginPagePassController> {
  const LoginPagePassView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(children: [
        Image.network("https://mpf-public-data.s3.ap-south-1.amazonaws.com/app-resources/images/cover.png"
         ,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  10.heightBox,
                  buildTextPassField('Password', passwordcontroller),

                  20.heightBox,
                  Obx(
                    () {
                      return query.isLoading.value == true ? Center(child: CircularProgressIndicator()) : ButtonPrimary(title: "Continue").onInkTap(() {
                        query.signinpass(
